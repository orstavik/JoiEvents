...
Events are like dominos. One event falls down, and then it triggers another event to fall down, which in turn starts a third event, etc. until a long array of elements have fallen one by one.  
